...
<div id='container'>
	...
	<div id="contentt">
		<div class="artikel">
			...
			{
				default:
				include "../guru/konten.php";
				break;
				
				case "ebook";
				include "../guru/ebook.php";
				break;
				
				case "buku";
				include "../guru/buku.php";
				break;
				
				case "status";
				include "../guru/status.php";
				break;
				
				case "keranjang";
				include "../guru/keranjang.php";
				break;
				
				case "selesai";
				include "../guru/selesai.php";
				break;
				
				case "kategori";
				include "../guru/kategori.php";
				break;
				
				case "ekategori";
				include "../guru/ekategori.php";
				break;
			}
			?>
		</div>
