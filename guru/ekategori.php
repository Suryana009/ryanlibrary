...
$query2=mysql_query("SELECT * FROM ebook where id_ekategori='$id_ekategori'");
...
<td align=center>			 
    ...
    <div>
        <a href="../files/<?php echo $data['file']; ?>"><img width="100" height="40" src="../images/download_button.png" /></a>
	</div>
